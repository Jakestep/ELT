...
export const metadata = {
  ...
  description: "Tech tips without the headache. Read about digital minimalism, smart automation, and healthy ways to use tech in life and business.",
  keywords: ["Healthy tech blog", "Digital wellness", "Tech tips for founders", "Software advice"],
  openGraph: {
    title: "Blog | EverLessTech",
